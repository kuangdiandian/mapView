...
- (instancetype)initWithTitle:(NSString *)title target:(id)target action:(SEL)action
{
    ...
    CGFloat textW = [self getTextSize:title font:font maxSize:CGSizeMake(KGBScreenW, 44)].width;
...
- (void)setBtTitle:(NSString *)btTitle
{
    _btTitle = btTitle;
    UIFont *font = [UIFont systemFontOfSize:16.0];
    CGFloat textW = [self getTextSize:btTitle font:font maxSize:CGSizeMake(KGBScreenW, 44)].width;
